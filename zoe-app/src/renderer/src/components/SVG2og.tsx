...
export default function Svg2og() {
    ...
    return (
        <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            ...
            {/* Rectangle Elements displaying rooms*/}
                    <g id="rooms" stroke-width={2.5} stroke='#252525' fill='#fff6aeff'>
                        <rect
                            id="2th3"
                            width="61.727619"
                            height="25.614208"
            ...
            {/* Text labels displaying room names*/}
                    <g id="labels" font-family="Arial" font-fize="14" fill="#252525" visibility="hidden">
                        ...
                        <text id='k2012' x="20" y="720">Umkleide H</text>
                        ...
                        <text id='k2020' x="130" y="350">Umkleide H</text>
                        <text id='k2022' x="240" y="350">Umkleide D</text>
                        ...
                        <text id='k2007' x="340" y="710">Umkleide</text>
                        <text id='0002' x="400" y="740">0002</text>
                        <text id='k2007' x="420" y="740">Umkleide</text>
